...
<script>
	function ajaxEvent() {
		...
		httpRequest.open("POST", "../ajaxService.htm?username=" + queryString,
				true);
		httpRequest.send();
	}
</script>
		...
		<table>
			...
			<tr>
				...
				<td><form:input path="firstName" size="30"
						pattern='([A-Z]{1}[a-z]{1,30})' required="true" /></td>
			</tr>
			...
			<tr>
				...
				<td><input = "text" value="Format = +()0000000000"
					readonly="true" /></td>
			</tr>
			...
			<tr>
				<td>Email(Primary):</td>
				<td><form:input path="email1" size="30" required ="true"
						pattern="^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*\.(([0-9]{1,3})|([a-zA-Z]{2,3})|(aero|coop|info|museum|name))$" /></td>
			</tr>

			<tr>
				<td>Email(Secondary):</td>
				<td><form:input path="email2" size="30" pattern="^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*\.(([0-9]{1,3})|([a-zA-Z]{2,3})|(aero|coop|info|museum|name))$" /></td>
			</tr>
			...
			<tr>
				...
				<td><form:input path="streetAddr1" size="30" /></td>
			</tr>
			...
			<tr>
				<td>Zip Code:</td>
				<td><form:input path="zipcode" size="30" pattern="([0-9]{5})" /></td>
			</tr>
